...
def _register_builtin_models():
    ...
    def _build_lingbotva_wan(cfg: DictConfig, torch_dtype):
        from rlinf.models.embodiment.lingbotva_wan import get_model
    ...
    register_model(
        SupportedModel.LINGBOTVA_WAN.value,
        _build_lingbotva_wan,
        category="embodied",
        force=True,
    )
    register_model(
